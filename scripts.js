window.onload = function() {
    ...
    function main(tframe) {
        ...
        if (!initialized) {
            ...
            context.strokeStyle = "#C391D9";
            context.lineWidth=3;
            context.strokeRect(18.5, 0.5 + canvas.height - 51, canvas.width-37, 32);
            context.fillStyle = "#4A3752";
            context.fillRect(18.5, 0.5 + canvas.height - 51, loadpercentage*(canvas.width-37), 32);
            
            var loadtext = "Cargando " + loadcount + "/" + loadtotal + " imagenes";
    ...
    function render() {
        ...
        drawCenterText("Puntaje:", scorex, scorey, 150);
        ...
        if (gamestate == gamestates.gameover) {
            ...
            drawCenterText("Click para comenzar", level.x, level.y + level.height / 2 + 40, level.width);
        }
    }
